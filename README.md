...
1. visual select
2. Enter
3. space or : or anyother   if multiple space ,time number space  likewise.



## delete the trailling whitespace
...
## Ag : let you search context in files of project , flying ^-^
[Ag][4], `apt-get install silversearcher-ag`
...
## fugutive Gdiff Gread Gwrite

Gdiff is good, let you know what is different.
